...
<x-layouts.panel :title="$title" role-label="Şoför paneli" role-color="text-emerald-500" dashboard-route="driver.dashboard"
    ...
    :nav="[
        ...
        ['label' => 'İlan havuzu ve tekliflerim', 'route' => 'driver.loads.index', 'match' => 'driver.loads.*', 'icon' => 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10'],
        ['label' => 'Sevkiyatlarım', 'route' => 'driver.shipments.index', 'match' => 'driver.shipments.*', 'icon' => 'M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0'],
        ['label' => 'Cüzdan ve hakedişler', 'route' => 'driver.wallet.index', 'match' => 'driver.wallet.*', 'icon' => 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z'],
