    ...
    <div class="max-w-5xl mx-auto px-6 md:px-12 space-y-16 animate-fade-in">
        ...
        <div class="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed">
                İlan sihirbazımız ile dorse tipi, rota ve bütçe stratejinizi girerek ilanınızı anında açın. Güvenceli ödeme sistemiyle teslimata kadar riskinizi sıfırlayın.
            </p>
        </div>
