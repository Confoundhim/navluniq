<x-layouts.frontend title="Hizmetlerimiz - NavlunIQ Akıllı Lojistik Çözümleri">
    <div class="max-w-5xl mx-auto px-6 md:px-12 space-y-16 animate-fade-in text-xs">

        <div class="text-center space-y-4 max-w-3xl mx-auto">
            <span class="text-xs font-black text-brand-500 uppercase tracking-widest">HİZMETLERİMİZ</span>
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed">
                İlan aboneliğinden şehir içi ve şehirler arası taşımacılığa kadar ihtiyacınıza uygun akıllı çözümler.
            </p>
        </div>
        ...
        <div class="space-y-8">
            ...
            <!-- Hizmet 2 -->
            <div class="apple-glass rounded-3xl p-8 md:p-10 space-y-4 border-l-4 border-l-blue-500 shadow-apple-sm">
                <span class="font-bold text-blue-500 text-sm">2. Şehir İçi Yük Taşımacılığı</span>
                <p class="text-neutral-500 leading-relaxed">
