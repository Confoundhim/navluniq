<x-layouts.frontend title="Hakkımızda - NavlunIQ Akıllı Lojistik Ağı">
    <div class="max-w-5xl mx-auto px-6 md:px-12 space-y-16 animate-fade-in">
        ...
        <div class="text-center space-y-4 max-w-3xl mx-auto">
            <span class="text-xs font-black text-brand-500 uppercase tracking-widest">BİZ KİMİZ?</span>
            <h1 class="text-3xl sm:text-5xl font-black text-neutral-950 dark:text-white tracking-tight">
                Lojistikte Sarsılmaz Güven Köprüsü
            </h1>
            <p class="text-sm sm:text-base text-neutral-500 dark:text-neutral-400 leading-relaxed">
                Biz sadece bir lojistik yazılımı kodlamadık. Gece gündüz direksiyon başında ömür tüketen şoförlerimiz ile, alın terini ve tüm sermayesini o yüke emanet eden iş insanlarımızın arasına sarsılmaz bir güven köprüsü kurduk.
            </p>
        </div>

        <!-- İkili Anlatım Kartları (Şoförler & Yük Sahipleri İçin) -->
        ...
        <!-- Büyük Amacımız -->
        <div class="apple-glass rounded-3xl p-10 text-center space-y-4 shadow-apple-lg border border-neutral-200/50">
            <span class="text-xs font-black text-brand-500 uppercase tracking-wider">MİSYONUMUZ</span>
            <blockquote class="text-xl sm:text-2xl font-black text-neutral-900 dark:text-white max-w-2xl mx-auto leading-snug">
                "Lojistikte en değerli olan, yük sahibi ve şoför arasında kurulan güvendir. Biz ise buna hizmet ediyoruz."
            </blockquote>
        </div>
