...
class VehicleClassifierTest extends TestCase
{
    ...
    public static function corpus(): array
    {
        return [
            ...
            // Panelvan
            ['Uzun panelvan lazım 1500 kg koli Ankara Eskişehir', 'uzun_panelvan'],
            ['Sprinter uzun şasi arıyoruz Bursa İstanbul', 'uzun_panelvan'],
            ['Transit lazım 2 ton koli İzmir Aydın', 'uzun_panelvan'],
            ['Panelvan lazım 1 ton koli İstanbul Kocaeli 0537 000 11 22', 'orta_panelvan'],
            ['Ducato ile gidecek 20 koli Ankara Kırşehir', 'orta_panelvan'],
            ['Kapalı kasa 1000 kg elektronik Gebze İstanbul', 'orta_panelvan'],
            // Minivan / otomobil
            ['Doblo lazım 300 kg numune Bursa İzmir', 'minivan'],
            ['Caddy kangoo fiorino olur 5 koli İstanbul Tekirdağ', 'minivan'],
            ['Hafif ticari araç lazım Ankara Çankırı', 'minivan'],
            ['500 kg yük var Antalya Isparta', 'minivan'],
            ['Otomobille gidecek evrak Ankara İstanbul', 'otomobil'],
            ['Binek araç lazım Bursa Yalova', 'otomobil'],
            ['200 kg paket İzmir Manisa', 'otomobil'],
