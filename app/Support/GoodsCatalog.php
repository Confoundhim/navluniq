...
final class GoodsCatalog
{
    ...
    private const CATEGORIES = [
        ...
        'beyaz_esya' => ['label' => 'Beyaz eşya', 'min_vehicle' => 'panelvan', 'traits' => ['fragile'],
        ...
        'mobilya' => ['label' => 'Mobilya / ev eşyası', 'min_vehicle' => 'panelvan', 'traits' => ['fragile'],
        ...
        'elektronik' => ['label' => 'Elektronik', 'min_vehicle' => 'panelvan', 'traits' => ['fragile'],
        ...
        'palet' => ['label' => 'Paletli yük', 'min_vehicle' => 'kamyonet', 'traits' => [],
            'pattern' => '/\bpalet\w*/'],
        'koli' => ['label' => 'Koli / paket', 'min_vehicle' => 'panelvan', 'traits' => [],
            'pattern' => '/\b(?:koli|paket|kutu|karton|parca\s+yuk|parsiyel\s+koli)\w*/'],
        'evrak' => ['label' => 'Evrak / numune', 'min_vehicle' => 'panelvan', 'traits' => [],
