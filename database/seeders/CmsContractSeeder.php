...
<div class="space-y-6 text-neutral-800 dark:text-neutral-200 leading-relaxed">
    ...
    <div class="space-y-3">
        ...
        <ul class="list-disc pl-5 space-y-1.5">
            ...
            <li data-clause="dis-kaynak"><strong>Meşru Menfaat (KVKK m. 5/2-f) – Dış Kaynak İlanları:</strong> Yöneticisinin veya ilan sahibinin paylaşımına izin verdiği taşımacılık gruplarında alenen paylaşılan yük ilanları (güzergâh, yük, araç, fiyat ve ilan sahibinin iletişim numarası) standart ilan kartına dönüştürülerek işlenir. İletişim numarası şifreli saklanır, herkese açık gösterimlerde maskelenir ve yalnız kimlik ve belge doğrulaması tamamlanmış sürücülere gösterilir; ilanlar en geç 30 gün sonunda silinir. İlan sahibi, <strong>{{COMPANY_EMAIL}}</strong> adresine veya iletişim formuna yazarak ilanının derhal kaldırılmasını isteyebilir.</li>
        </ul>
    </div>
