...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('saved_addresses', function (Blueprint $table) {
            ...
            $table->string('type', 16)->default('both')->index();
        ...
        Schema::create('reviews', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['load_id', 'reviewer_id', 'reviewee_id']);
        ...
        Schema::create('insurance_quotes', function (Blueprint $table) {
            ...
            $table->string('provider_quote_id')->nullable()->index();
            $table->decimal('insured_value', 19, 4);
            $table->decimal('premium_amount', 19, 4);
        ...
        Schema::create('insurance_policies', function (Blueprint $table) {
            $table->id();
            $table->foreignId('insurance_quote_id')->constrained()->restrictOnDelete();
            $table->foreignId('payment_order_id')->nullable()->constrained()->restrictOnDelete();
            $table->string('provider_policy_id')->nullable()->unique();
            $table->string('policy_number')->nullable()->unique();
            $table->string('status', 24)->default('pending')->index();
            $table->timestamp('starts_at')->nullable();
            $table->timestamp('ends_at')->nullable();
            $table->string('document_disk', 64)->nullable();
        ...
        Schema::create('insurance_claims', function (Blueprint $table) {
            ...
            $table->foreignId('dispute_id')->nullable()->constrained()->restrictOnDelete();
            $table->string('provider_claim_id')->nullable()->unique();
        ...
        Schema::create('coupon_redemptions', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['coupon_id', 'user_id', 'payment_order_id']);
        });
    }
